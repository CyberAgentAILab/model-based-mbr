...
def sample(dataset, tokenizer, model, src_lines, torch_device, n_lines, n_samples, bsz, 
...
""".format(
            ...
            model_inputs = tokenizer(input_source, return_tensors="pt", return_token_type_ids=False).to(model.device)
...
if __name__ == "__main__":
    ...
    sample(dataset, tokenizer, model, src_lines, torch_device, n_lines, n_samples, bsz, 
           eps, topk, topp, True, 0.0,
           prompt, stop_tokens,
